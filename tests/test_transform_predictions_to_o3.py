...
def test_transform_splits_multi_source_event_items():
    payload = {
        ...
        "items": [
            {
                ...
                "parent_source_audio_files": [
                    "ICLISTENHF6016_20250401T022000.000Z.flac",
                    "ICLISTENHF6016_20250401T022500.000Z.flac",
                ],
                "paths": {
        ...
        "events": [{"event_id": "event-001"}],
        "postprocessing": {"method": "temporal_cluster_hysteresis_v1"},
    }
